 ...
 * 
 * Takes in two fibonnaci indexes and finds the integeres and 
 * can use one of two methods to determine the greatest 
 * common divider between those two integers.
 */
...
public class FibonacciGCD {
	...
	//Determine GCD by comparing all integers leading up to the smaller value
	...
	//Determine GCD by comparing all integers starting at the min value 
	// divided by two, using the first common divisor
